...
public class LlistatClubsJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TaulaClubs.setBackground(new java.awt.Color(255, 255, 255));
        TaulaClubs.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        TaulaClubs.setForeground(new java.awt.Color(0, 0, 0));
